...
4. [Enable Wi-Fi using these instructions](https://linuxconfig.org/ubuntu-22-04-connect-to-wifi-from-command-line) (Be sure to use uBlock Origin on this site.)
